...
# ST7735S based 160x80 (RGB565) Example

This is an example of using the **ST7735S based 160x80** display in **RGB565** (16-bit) mode.
...
- How the initialization commands are sent
